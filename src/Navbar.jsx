                ...
                <div className={`fixed ${isOpen ? 'translate-x-0' : 'translate-x-full'} transition-transform duration-500 w-[280px] h-screen right-0 top-0 bg-blue-100 font-inter`}>
                    <div className='ml-12 mt-28 tracking-wide text-gray-700'>
                        ...
                        <ul className='flex flex-col space-y-6 text-3xl font-bold transition-colors'>
                                <li className={`${isOpen ? 'translate-x-0 duration-600' : 'translate-x-100 duration-600'} active:text-red-600 transition-all active:duration-300 hover:text-red-600 hover:duration-50`}>Home</li>
                                <li className={`${isOpen ? 'translate-x-0 duration-700' : 'translate-x-100 duration-700'} active:text-red-600 transition-all active:duration-300 hover:text-red-600 hover:duration-50`}>Team</li>
                                <li className={`${isOpen ? 'translate-x-0 duration-800' : 'translate-x-100 duration-800'} active:text-red-600 transition-all active:duration-300 hover:text-red-600 hover:duration-50`}>Clients</li>
                                <li className={`${isOpen ? 'translate-x-0 duration-900' : 'translate-x-100 duration-900'} active:text-red-600 transition-all active:duration-300 hover:text-red-600 hover:duration-50`}>About us</li>
                        </ul>
                    </div>
                </div>
            </div>
